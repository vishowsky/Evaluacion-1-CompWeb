<%-- 
    ...
    Created on : 3 may 2021, 18:54:21
    Author     : visho
--%>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="card-body">
    ...
    <a href="adminCategorias.jsp" class="card-link" style="margin-left: 150px ; color: white"><i class="fas fa-angle-double-left"></i>  Volver al listado</a>
        ...
        <div >
            <a style="font-size: xx-large;">Crear nueva categoria</a>
        </div>
     
        <div style="margin-top: 40px ">
        <div id="textExample1" class="form-text" style="font-size: large">
  Descrpicion
</div>
    ...
    <input type="text" class="form-control" placeholder="">
            ...
            <button type="button" class="btn btn-primary" style="margin-top: 20px ">Guardar categoria</button>
</div>
